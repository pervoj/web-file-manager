<?php
  ...
  function vyhodnot($soubor, $name, $info, $files, $fName) {
    return($soubor != 'fileviewer.php' && $soubor != 'admin.php' && $soubor != $name && $soubor != $info && $soubor != $files && $fName != '.');
  }
...
<html lang="cs" dir="ltr">
  ...
  <body>
    ...
    ?>
    <footer>
      <p>powered by <a href="https://gitlab.com/pervoj/web-file-manager">Web file manager 1.0</a></p>
      <p>&copy; <?php echo($roky); ?> <a class="vt" href="http://pervoj.epizy.com/">pervoj</a></p>
    </footer>
  </body>
</html>
